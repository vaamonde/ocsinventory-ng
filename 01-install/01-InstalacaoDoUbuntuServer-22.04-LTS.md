...
02. Versão do download Ubuntu Server: ubuntu-22.04.3-live-server-amd64.iso (20/02/2024)
...
Atualização do VirtualBOX no Linux Mint: https://www.youtube.com/watch?v=DU47PLFSxpA
	...
	_		Nome: ocsinventory
	_		Pasta da Máquina: #PATH_PADRÃO\ocsinventory (altere conforme a sua necessidade)
	_		Tipo: Linux
	_		Versão: Ubuntu 22.04 LTS (Jammy Jellyfish) (64-bit)
	_	<Próximo>
	...
	_ 08. Configurações da Máquina Virtual ocsinventory (Propriedades/Configurações)
	_	Sistema
	_		Placa Mãe
...
Instalação do Ubuntu Server: https://ubuntu.com/server/docs/installation
	...
	_ 		Your server's name: ocsinventory <Tab>
	...
	_ ocsinventory login: vaamonde <Enter> (altere para o seu usuário)
